        ...
        <div className="bg-white">
            <div className="flex items-center justify-between mx-auto max-w-7xl h-16 px-4">
                ...
                <div className="flex items-center gap-2">
                    <img src="Untitled design.svg" alt="Logo" className="h-8 w-8" />
                    <h1 className="text-2xl font-bold">
                    <Link to="/"> Job<span className="text-[#02e8f8]">Lytics</span></Link>
                    </h1>
                </div>
                ...
                <div className={`md:flex items-center gap-12 ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
                    ...
                    {!user ? (
                        <div className="flex flex-col md:flex-row items-center gap-2">
                            <Link to="/login"><Button variant="outline" onClick={() => setIsMobileMenuOpen(false)}>Login</Button></Link>
                            <Link to="/signup"><Button className="bg-[#6A38C2] hover:bg-[#5b30a6]" onClick={() => setIsMobileMenuOpen(false)}>Signup</Button></Link>
                        </div>
                    ) : (
                        <Popover>
